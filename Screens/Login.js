    ...
    return (
        <View style={styles.container}>
            <View style={styles.header}>
                ...
                <code style={{color: '#fff', fontSize: 40, fontWeight: '700', marginLeft: 25}}>Login</code>
            </View>
            ...
            <View style={styles.LoginNow}>
                <code style={{fontSize: 25, fontWeight: '600', color: '#fff'}}>Login</code>
            </View>
            <View style={{marginTop: 10, justifyContent: 'center', flexDirection: 'row', color: '#fff', fontSize: 15}}>
                <code>Already have an account?</code>
                <code style={{fontWeight: '1000', marginLeft: 5}} onClick={() => navigation.navigate('SignUp')}>Create an account</code>
            </View>
        </View>
    )
}
